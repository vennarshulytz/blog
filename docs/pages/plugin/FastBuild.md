# FastBuild：让你的编译快人一步，效率飙升！

今天，我想给大家介绍一款针对 `Build`的 idea 插件：[FastBuild](https://plugins.jetbrains.com/plugin/27467-fastbuild)

## 作用

快速构建项目。
仅仅编译当前项目中所有“打开”并且发生“修改”的 Java 文件。

## 优势

1. 和类似功能的插件相比，更加轻量、体积小，最新版仅仅 `13.18 KB`
2. 和类似功能的插件相比，更加易于使用
...
在` File | Settings | Plugins `中搜索 FastBuild

![image-20250609163528997](img/FastBuild.assets/image-20250609163528997.png)
...
![FastBuild](img/FastBuild.assets/FastBuild.png)

![FastBuild_new](img/FastBuild.assets/FastBuild_new.png)
